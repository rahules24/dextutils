"""
Django settings for dextutils project.
...
ALLOWED_HOSTS = ['https://dextutils.onrender.com', '127.0.0.1', 'localhost']
...
ROOT_URLCONF = "dextutils.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "dexter-react/build"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "dextutils.wsgi.application"
